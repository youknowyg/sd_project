...
#define EVE_APP_ERR_CODE    (1) //0xFF00
...
extern FTU8 appEVEFLHPath (FTC8 *path, FTU32 *len);
...
extern FTU32 appEVEFLHSrcToDes (FTU32 handle, FTU32 src, FTU32 des, FTU32 len, FTU8 update);
extern FTU32 appEVEFLHAddr(FTC8 *path);
extern FTU32 appEVEFLHLen(FTC8 *path);
extern FTVOID appEVEFLHUnzip(FTC8 *path, FTU32 src);
extern FTU8 appEVEFLHSetFull(FTVOID);
extern FTU8 appEVEFLHToEVE(FTU32 f_addr, FTU32 e_addr, FTU32 len);
extern FTVOID appEVEFLHErase(FTVOID);
extern FTU8 appEVEFLHUpdate(FTU32 f_addr, FTU32 e_addr, FTU32 len);
extern FTU32 appEVEFLHVerify(FTU8 *golden_file, FTU32 f_addr);
extern FTU32 appEVEFLHProgProgress(FTU8 *f_file, FTU32 f_addr, FTU32 block, FTU8 update);
